...
local normal_mappings = {
    ...
    { '<leader>s+', ':resize +15<cr>', desc = 'Increase window height' },
    { '<leader>s_', ':resize -15<cr>', desc = 'Decrease window height' },
    { '<leader>sK', ':resize +15<cr>', desc = 'Increase window height' },
    { '<leader>sJ', ':resize -15<cr>', desc = 'Decrease window height' },
    { '<leader>s=', ':vertical resize +30<cr>', desc = 'Increase window width' },
    { '<leader>s-', ':vertical resize -30<cr>', desc = 'Decrease window width' },
    { '<leader>sL', ':vertical resize +30<cr>', desc = 'Increase window width' },
    { '<leader>sH', ':vertical resize -30<cr>', desc = 'Decrease window width' },
