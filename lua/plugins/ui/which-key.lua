...
local normal_mappings = {
    ...
    { '<leader>ghi', ':lua Snacks.picker.gh_issue()<cr>', desc = 'GitHub Issues (open)' },
    { '<leader>ghI', ':lua Snacks.picker.gh_issue({ state = "all" })<cr>', desc = 'GitHub Issues (all)' },
    { '<leader>ghp', ':lua Snacks.picker.gh_pr()<cr>', desc = 'GitHub Pull Requests (open)' },
    { '<leader>ghP', ':lua Snacks.picker.gh_pr({ state = "all" })<cr>', desc = 'GitHub Pull Requests (all)' },
    ...
    { '<leader>lg', ':lua vim.lsp.buf.hover()<cr>', desc = 'Hover Documentation' },
    { '<leader>lh', ':lua Snacks.toggle.inlay_hints():toggle()<cr>', desc = 'Toggle Inlay Hints' },
    ...
    { '<leader>lw', ':lua Snacks.toggle.words():toggle()<cr>', desc = 'Toggle Word References' },
    ...
    { '<leader>sa', ':vsplit<cr>', desc = 'Vertical Split' },
    ...
    { '<leader>ss', ':AutoTile<cr>', desc = 'Auto Split' },
    ...
    { '<leader>tf', ':Tterm<cr>', desc = 'Full / Curret Terminal' },
    { '<leader>tn', ':Sterm node<cr>', desc = 'Node' },
    { '<leader>tp', ':Sterm python<cr>', desc = 'Python' },
    { '<leader>tr', ':Sterm irb<cr>', desc = 'Ruby' },
    { '<leader>ts', ':Sterm<cr>', desc = 'Horizontal Terminal' },
    { '<leader>tt', ':Fterm<cr>', desc = 'Floating Terminal' },
    ...
    { '<leader>un', ":lua Snacks.toggle.option('wrap', { name = 'Wrap' }):toggle()<cr>", desc = 'Line Wrap' },
    {
        '<leader>ur',
        ":lua Snacks.toggle.option('relativenumber', { name = 'Relative Numbers' }):toggle()<cr>",
        desc = 'Relative Numbers',
    },
    { '<leader>us', ":lua Snacks.toggle.option('spell', { name = 'Spellcheck' }):toggle()<cr>", desc = 'Spellcheck' },
    { '<leader>uw', ':lua Snacks.toggle.words():toggle()<cr>', desc = 'LSP Word References' },
    { '<leader>uz', ':lua Snacks.toggle.zen():toggle()<cr>', desc = 'Zen' },

    { '<leader>w', group = ' Writing' },
    { '<leader>wc', ":lua Snacks.toggle.option('spell', { name = 'Spellcheck' }):toggle()<cr>", desc = 'Spellcheck' },
    { '<leader>wd', ':lua Snacks.toggle.dim():toggle()<cr>', desc = 'Dim' },
    ...
    { '<leader>wz', ':lua Snacks.toggle.zen():toggle()<cr>', desc = 'Zen' },
    { '<leader>wZ', ':lua Snacks.zen.zoom()<cr>', desc = 'Zoom' },
...
local no_leader_mappings = {
    ...
    { '<C-g>', ':lua Snacks.lazygit()<cr>', desc = 'Lazygit' },
