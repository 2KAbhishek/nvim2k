...
local normal_mappings = {
    ...
    { '<leader>tS', ':STerm<cr>', desc = 'Horizontal Terminal - Top' },
    { '<leader>tt', ':Fterm<cr>', desc = 'Floating Terminal' },
    { '<leader>tv', ':Vterm<cr>', desc = 'Vertical Terminal' },
    { '<leader>tV', ':VTerm<cr>', desc = 'Vertical Terminal - Left' },
    ...
    { '<leader>uw', ":lua Snacks.toggle.option('wrap', { name = 'Wrap' }):toggle()<cr>", desc = 'Wrap' },
