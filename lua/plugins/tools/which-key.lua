...
local mappings = {
    ...
    s = {
        ...
        ['_'] = { '<cmd>resize -20<cr>', 'Decrease window height' },
        ['+'] = { '<cmd>resize +20<cr>', 'Increase window height' },
        ...
        j = { '<C-w>j', 'Move Down' },
        J = { '<cmd>resize -10<cr>', 'Decrease window height' },
        k = { '<C-w>k', 'Move Up' },
        K = { '<cmd>resize +10<cr>', 'Increase window height' },
        l = { '<C-w>l', 'Move Right' },
